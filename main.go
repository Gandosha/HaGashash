...
func main() {	
	...
	switch {
		...
		case *hostPtr == "nil" && *subnetPtr == false && *subnetsPtr == false:
			...
			fmt.Println("\n")
			os.Exit(1)
		case *interfacePtr != "nil" && *hostPtr == "nil" && *projectNamePtr != "nil" && *subnetPtr == false && *subnetsPtr == true:
		...
		case *interfacePtr != "nil" && *hostPtr == "nil" && *projectNamePtr != "nil" && *subnetPtr == true && *subnetsPtr == false:
		...
		case *interfacePtr != "nil" && *hostPtr != "nil" && *projectNamePtr != "nil" && *subnetPtr == false && *subnetsPtr == false:	
